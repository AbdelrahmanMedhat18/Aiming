...
import 'package:newecommerce/src/features/authentication/controllers/otp_controller.dart';
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("$tOtpMessage + support@code.com",textAlign: TextAlign.center,),
